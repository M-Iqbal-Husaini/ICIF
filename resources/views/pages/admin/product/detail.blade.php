                        ...
                        <div class="article-title">
                            <h2>
                                @if ($product->discount > 0)
                                    <!-- If there is a discount, show original price with strike-through and the discounted price -->
                                    <span style="text-decoration: line-through; color: black;">{{ $product->price }} Points</span>
                                    <span class="ml-2" style="color: red;">{{ $product->price - ($product->price * $product->discount / 100) }} Points</span>
                                @else
                                    <!-- No discount -->
